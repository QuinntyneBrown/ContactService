...
namespace ContactService.Features.ContactRequests
{
    ...
    {
        public class AddOrUpdateContactRequestRequest : IRequest<AddOrUpdateContactRequestResponse>
        {
            public ContactRequestApiModel ContactRequest { get; set; }
            public Guid TenantUniqueId { get; set; }
        }

        public class AddOrUpdateContactRequestResponse { }

        public class AddOrUpdateContactRequestHandler : IAsyncRequestHandler<AddOrUpdateContactRequestRequest, AddOrUpdateContactRequestResponse>
        {
            public AddOrUpdateContactRequestHandler(ContactServiceContext context, ICache cache)
            {
                _context = context;
                _cache = cache;
            }

            public async Task<AddOrUpdateContactRequestResponse> Handle(AddOrUpdateContactRequestRequest request)
            {
                ...
                return new AddOrUpdateContactRequestResponse();
            }
