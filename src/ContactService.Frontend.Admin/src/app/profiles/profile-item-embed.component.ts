...
const template = require("./profile-item-embed.component.html");
const styles = require("./profile-item-embed.component.scss");

export class ProfileItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new ProfileDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new ProfileEdit(this.entity));
    }
...
customElements.define(`ce-profile-item-embed`,ProfileItemEmbedComponent);
