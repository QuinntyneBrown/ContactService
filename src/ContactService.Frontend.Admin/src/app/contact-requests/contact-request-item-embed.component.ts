...
const template = require("./contact-request-item-embed.component.html");
const styles = require("./contact-request-item-embed.component.scss");

export class ContactRequestItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new ContactRequestDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new ContactRequestEdit(this.entity));
    }
    ...
    public entity: ContactRequest;
}

customElements.define(`ce-contact-request-item-embed`,ContactRequestItemEmbedComponent);
